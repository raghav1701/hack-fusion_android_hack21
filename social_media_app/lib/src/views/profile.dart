...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> getUserInfo() async {
    ...
    var result = await FirestoreService()
        .getUserInfo(sharedPreferences.authLevel, FirebaseAuthService.user.uid);
  ...
  Future<void> getUserPosts() async {
    ...
    var result =
        await FirestoreService().getUserPosts(FirebaseAuthService.user.uid);
  ...
  Widget buildPersonalDetails(BuildContext context) {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(
            FirebaseAuthService.user.displayName + ' (Lv. $userLevel)',
            style: TextStyle(
    ...
    return Row(
      children: [
        userLevel < 3
            ...
            : Container(),
        userLevel < 3 ? SizedBox(width: 8.0) : Container(),
        Expanded(
          child: OutlinedButton.icon(
            onPressed: () {},
